...
def generate_domain_weight_ablation_report(experiment_results, target_city):
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    domain_weights = [0, 0.01, 0.05, 0.10, 0.20]

    FIXED_MMD_WEIGHT = 0.1

    for target_city in all_cities:
        source_cities = [c for c in all_cities if c != target_city]
        print(f"\nRunning domain_weight ablation: Target={target_city}, Sources={source_cities}")
        ...
        for domain_weight in domain_weights:
            ...
            experiment_results[domain_weight] = {
        ...
        # ---------- 单城市报告 ----------
        generate_domain_weight_ablation_report(experiment_results, target_city)
