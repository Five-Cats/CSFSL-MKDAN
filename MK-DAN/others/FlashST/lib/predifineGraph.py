...
def pre_graph_dict(args):
    ...
    for data_graph in args.dataset_graph:
        ...
        elif data_graph == 'chengdu_didi' or data_graph == 'nyc_bike0' or data_graph == 'DCwashington' or data_graph == 'Chicago' or data_graph == 'nyc_bike1' or data_graph == 'nyc_bike2' or data_graph == 'LABike' or data_graph == 'NYCBike':
