...
def load_all_adj(device):
    ...
    adj_nycbike = np.load(f'E:/trans/DAN/DASTNet/data/NYCBike/NYCBike_matrix.npy').astype(np.float32)
    adj_washington = np.load(f'E:/trans/DAN/DASTNet/data/Washington/Washington_matrix.npy').astype(np.float32)
    adj_chicago = np.load(f'E:/trans/DAN/DASTNet/data/Chicago/Chicago_matrix.npy').astype(np.float32)
    adj_labike = np.load(f'E:/trans/DAN/DASTNet/data/LABike/LABike_matrix.npy').astype(np.float32)

    return torch.tensor(adj_nycbike).to(device), torch.tensor(adj_washington).to(device), torch.tensor(adj_chicago).to(device), torch.tensor(adj_labike).to(device)
...
def load_data(args, scaler=None, visualize=False, distribution=False):
    ...
    # }
    DATA_PATHS = {
        "nycbike": {"feat": "E:/trans/DAN/DASTNet/data/NYCBike/NYCBike.npz", "adj": "E:/trans/DAN/DASTNet/data/NYCBike/NYCBike_matrix.npy"},
        "washington": {"feat": "E:/trans/DAN/DASTNet/data/Washington/Washington.npz", "adj": "E:/trans/DAN/DASTNet/data/Washington/Washington_matrix.npy"},
        "chicago": {"feat": "E:/trans/DAN/DASTNet/data/Chicago/Chicago.npz", "adj": "E:/trans/DAN/DASTNet/data/Chicago/Chicago_matrix.npy"},
        "labike": {"feat": "E:/trans/DAN/DASTNet/data/LABike/LABike.npz", "adj": "E:/trans/DAN/DASTNet/data/LABike/LABike_matrix.npy"},
    }
    time = False
    ...
    if args.dataset == 'nycbike':
        feat_dir = DATA_PATHS['nycbike']['feat']
        adj_dir = DATA_PATHS['nycbike']['adj']
        num_of_vertices = 36

    elif args.dataset == 'washington':
        feat_dir = DATA_PATHS['washington']['feat']
        adj_dir = DATA_PATHS['washington']['adj']
        num_of_vertices = 36

    elif args.dataset == 'chicago':
        feat_dir = DATA_PATHS['chicago']['feat']
        adj_dir = DATA_PATHS['chicago']['adj']
        num_of_vertices = 36

    elif args.dataset == 'labike':
        feat_dir = DATA_PATHS['labike']['feat']
        adj_dir = DATA_PATHS['labike']['adj']
        num_of_vertices = 36
    ...
    adj = np.load(adj_dir).astype(np.float32)
