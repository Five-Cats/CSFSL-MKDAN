...
parser.add_argument('--config_filename', default='config.yaml', type=str,
                        help='Configur ation filename for restoring the model.')
parser.add_argument('--test_dataset', default='chicago', type=str)
parser.add_argument('--data_list', default='nycbike_washington_labike',type=str)
