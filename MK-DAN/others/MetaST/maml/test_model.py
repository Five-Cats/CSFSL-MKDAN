...
def test(model, data_generator, sess, saver):
    ...
    for epoch in range(epochs):
        ...
        print("total_outputa shape:", total_outputa.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--city', type=str, default='chicagobike')
    parser.add_argument('--save_dir', type=str, default='E:/trans/ST/MetaST/models')
    parser.add_argument('--model_type', type=str, default='meta_metatrain_mem8')

    parser.add_argument('--test_model', type=str, default='model_9900')
    parser.add_argument('--test_days', type=int, default=3)
    parser.add_argument('--output_dir', type=str, default='E:/trans/ST/MetaST/outputs')
