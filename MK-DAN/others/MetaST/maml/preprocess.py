...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='E:/trans/ST/MetaST/raw_data')
    parser.add_argument('--filename', type=str, default='bike/chicagobike.npz')
    parser.add_argument('--cluster_file', type=str, default='')
    parser.add_argument('--seq_len', type=int, default=8)
    parser.add_argument('--cnn_nbhd_size', type=int, default=3)
    parser.add_argument('--save_dir', type=str, default='E:/trans/ST/MetaST/test_data')
    parser.add_argument('--save_filename', type=str, default='chicagobike_seq.npz')
