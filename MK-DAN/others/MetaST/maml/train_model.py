...
if __name__ == "__main__":
    ...
    parser.add_argument('--cities', type=str, default='washingtonbike,labike,nycbike')
    ...
    parser.add_argument('--test_num_updates', type=int, default=5)
    parser.add_argument('--threshold', type=float, default=0)
    parser.add_argument('--meta_lr', type=float, default=1e-5)
    parser.add_argument('--update_lr', type=float, default=1e-5)
    parser.add_argument('--cluster_loss_weight', type=float, default=1e-4)
